import type { EstimateSoftBadgeTone } from '@/types/estimates';

/** Canonical estimate (smetă) project status codes. */
...
/** Portal client can accept or reject when estimate is sent. */
