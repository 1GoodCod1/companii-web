export const publicRoMarketing = {
  contacts: {
    ...
    company: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            'Programezi lucrările în calendarul centralizat și le aloci angajaților mobili din echipă. Fiecare membru al echipei își vede vizitele de pe teren direct în panou, primind detaliile obiectivului, diagnosticul complet, parametrii măsurați de la clienți și statusul intervenției live.',
        },
        {
