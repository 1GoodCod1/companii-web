/**
 * I-05: Quick category templates for plan point types.
 *
 * Each template is a preset collection of point type → count mappings
 * that represent typical configurations (e.g. "Standard apartment"
 * for electrical work). The PlanWorkItemsPanel shows buttons to one-click
...
/**
 * Returns the list of quick templates for a given category slug.
 */
