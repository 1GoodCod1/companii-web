  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center gap-4 bg-white/70 backdrop-blur-md p-4 rounded-2xl border border-gray-100 shadow-sm">
      <div className="relative flex-1">
        <MagnifyingGlassIcon className="absolute left-3.5 top-1/2 -translate-y-1/2 size-4 text-gray-400" />
        <input
          type="text"
          value={search}
          onChange={(e) => onSearchChange(e.target.value)}
          placeholder="MagnifyingGlass blueprints by name or category..."
          aria-label="MagnifyingGlass blueprints"
