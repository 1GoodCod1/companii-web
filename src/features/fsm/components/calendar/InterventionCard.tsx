...
import { formatTimeRo } from '@/utils/date';
  ...
  return (
    <article className={cn(cabinetPanelClass, 'p-4 space-y-3 hover:shadow-md transition-shadow')}>
      ...
      <div className="bg-slate-50/80 p-3 rounded-xl text-xs text-gray-700 space-y-1.5">
        <div>
          <span className="text-gray-400 text-[10px] uppercase tracking-wide block mb-0.5">Beneficiar</span>
          {item.customer?.fullName}
        </div>
        <div>
          <span className="text-gray-400 text-[10px] uppercase tracking-wide block mb-0.5">Tehnician</span>
