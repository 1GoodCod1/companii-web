...
import type { Plan2dData, Plan2dRoofType, Plan2dRoomShapeType } from '@/entities/estimate/model/estimate-plan2d.types';
...
export type { EstimateMeasurementUnit } from '@/entities/estimate/model/estimateMeasurementUnits.constants';
export { ESTIMATE_MEASUREMENT_UNITS, isEstimateMeasurementUnit, normalizeEstimateUnit } from '@/entities/estimate/model/estimateMeasurementUnits.constants';
...
export type {
  ...
  Plan2dRoomShapeType,
  Plan2dWorkContext,
} from '@/entities/estimate/model/estimate-plan2d.types';
