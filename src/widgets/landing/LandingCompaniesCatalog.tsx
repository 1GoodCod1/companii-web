  ...
  return (
    <section className="py-20 sm:py-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <div className="pointer-events-none absolute -right-16 -top-16 size-56 rounded-full bg-violet-400/10 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-20 -left-10 size-48 rounded-full bg-indigo-400/10 blur-3xl" />
